function [ saidaAjustada ] = ajustePesoBCE(lambda, theta, saidaDesejada, saidaObtida, vetorEntrada, saidaVi, maxV, vetorV, valorB, tamanhoEntrada)
...
derivada = lambda * (1 - theta) * saidaV * (saidaB.');
